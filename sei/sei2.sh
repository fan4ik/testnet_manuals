...
# set vars
if [ ! $NODENAME_SEI ]; then
	read -p "Enter node name: " NODENAME_SEI
...
echo '================================================='
echo -e "Your node name: \e[1m\e[32m$NODENAME_SEI\e[0m"
echo -e "Your wallet name: \e[1m\e[32m$WALLET_SEI\e[0m"
...
# init
seid init $NODENAME_SEI --chain-id $SEI_CHAIN_ID
